...
export async function fetchMappedCaseStudies(mockFallback: CaseStudy[], isFeatured?: boolean): Promise<CaseStudy[]> {
  try {
    ...
    return backendData.map((cs: any) => ({
      ...
      slug: cs.slug,
      summary: cs.summary,
      coverImage: cs.coverImage || "https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&q=80",
      heroImage: cs.heroImage || "https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&q=80",
