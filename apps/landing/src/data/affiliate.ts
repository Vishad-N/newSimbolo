...
export const affiliateFaqs = [
  {
    id: "af-faq-1",
    question: "How much does it cost to join the affiliate program?",
    answer: "Joining our affiliate program is 100% free. There are no setup fees or hidden costs. Simply sign up, get your unique referral link, and start earning."
  },
  {
    id: "af-faq-2",
    question: "How and when do I get paid?",
    answer: "Commissions are paid out on the 1st of every month via Bank Transfer, PayPal, or UPI, provided you have met the minimum payout threshold of ₹5,000."
  },
  {
    id: "af-faq-3",
    question: "How long is the cookie duration?",
    answer: "We offer a generous 90-day cookie duration. If a user clicks your link and makes a purchase within 90 days, you will be credited with the sale."
  },
  {
    id: "af-faq-4",
    question: "Can I track my referrals and earnings?",
    answer: "Yes, once approved, you will get access to a dedicated dashboard where you can track your clicks, conversions, commissions, and overall performance in real-time."
  }
];
