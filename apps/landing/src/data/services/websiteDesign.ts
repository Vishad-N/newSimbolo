...
export const websitePackages: SharedPackage[] = [
  {
    ...
    buttonLink: "?auth=register&checkout=website-starter",
    features: [
      "Up to 5 Pages",
      "Mobile Responsive",
      "Basic SEO Setup",
  ...
  },
  {
    ...
    buttonLink: "?auth=register&checkout=website-professional",
    features: [
      "Up to 10 Pages",
      "Custom UI/UX Design",
      "Advanced SEO",
  ...
  },
  {
    ...
    buttonLink: "?auth=register&checkout=website-ecommerce",
    features: [
      "Unlimited Products",
...
export const websiteDesignFaqs = [
  {
    id: "wd-faq-1",
    question: "How long does it take to build a website?",
    answer: "Typically, a standard business website takes 2-4 weeks from design to launch. More complex e-commerce or custom web applications can take 6-12 weeks depending on the requirements."
  },
  {
    id: "wd-faq-2",
    question: "Will my website be mobile-friendly and SEO optimized?",
    answer: "Yes! Every website we design is fully responsive and built with a mobile-first approach. We also implement on-page SEO best practices to ensure your site ranks well on search engines."
  },
  {
    id: "wd-faq-3",
    question: "Do you provide hosting and maintenance?",
    answer: "Yes, we offer reliable hosting solutions and ongoing maintenance packages to keep your website secure, fast, and up-to-date."
  },
  {
    id: "wd-faq-4",
    question: "Can I update the website content myself?",
    answer: "Absolutely. We build most of our websites on user-friendly content management systems (CMS) so you can easily update text, images, and products without any coding knowledge."
  }
];
