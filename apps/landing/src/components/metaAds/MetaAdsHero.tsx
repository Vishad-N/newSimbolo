...
function HeroArt() {
  return (
    <div className="relative h-full w-full flex items-center justify-center lg:justify-end">
      <motion.div animate={{ y: [0, -10, 0] }} transition={{ repeat: Infinity, duration: 4.5 }} className="hidden md:grid absolute right-[12%] top-[24%] z-20 h-12 w-12 place-items-center rounded-[8px] border border-white/10 bg-[var(--surface)]/80 text-[#1877F2] font-bold text-xl">
        f
      </motion.div>
      <div className="hidden md:block absolute left-[28%] top-[67%] h-10 w-[250px] rounded-[50%] border border-[#E1306C]/25 bg-[#E1306C]/6 shadow-[0_0_30px_rgba(225,48,108,0.16)]" />
