...
export function ButtonCarousel(props: KlarnaCarouselProps) {
    const {
        items = DEFAULT_ITEMS,
        cardRadius = 0,
        imageWidth = 250,
    ...
    // Fix cardRadius handling to accept standard values
    const cardRadiusPx = cardRadius > 0 ? cardRadius : 0;
    const buttonRadiusPx = buttonRadius > 0 ? buttonRadius : 0;
        ...
        >
                    ...
                    >
                        {srcOf(list[active]?.image) ? (
                            ...
                            <div className="w-full h-full bg-primary/10 flex items-center justify-center">
                                <span className="text-4xl text-primary font-bold opacity-50">
                                    {list[active]?.label?.charAt(0) || "?"}
                                </span>
                            </div>
                        )}
            ...
            {labelShow && (
                <AnimatePresence mode="wait" initial={false}>
                    ...
                    >
                        <h3 className="text-2xl font-bold mb-1">{list[active]?.label ?? ""}</h3>
                        {list[active]?.sublabel && (
                        ...
                        >
                            ...
                            >
                                {srcOf(item?.buttonImage) ? (
                                    ...
                                    <div className="w-full h-full flex items-center justify-center bg-black/40 text-white font-bold">
                                        {item?.label?.charAt(0) || "?"}
                                    </div>
                                )}
                            </div>
