    ...
    <SectionCard className="p-6 md:p-8 flex flex-col">
      ...
      <div className="mt-6 grid gap-4 grid-cols-2 flex-1">
        {assets.map((asset, index) => {
          ...
          const colorStyle = colorMap[asset.accent] || "text-[var(--primary)] bg-[var(--accent-glow)] border-[var(--accent)]/5030";
      ...
      <div className="mt-6">
        <Link href="/dashboard/affiliate/assets" className="flex h-11 w-full items-center justify-center gap-2 rounded-[8px] border border-[var(--accent)]/5030 bg-[var(--accent-glow)] text-[0.85rem] font-bold text-[#ffffff] transition hover:bg-[var(--primary)]/20">
