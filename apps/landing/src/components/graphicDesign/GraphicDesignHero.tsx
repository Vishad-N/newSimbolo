...
function HeroVisual() {
 ...
 <Link href="/contact?service=graphic-design" className="relative mt-4 inline-flex h-9 w-full items-center justify-center rounded-[6px] bg-[var(--primary)] text-[0.8rem] font-bold text-[#ffffff] transition hover:bg-[var(--primary-hover)] hover:-translate-y-[2px] hover:shadow-[0_12px_28px_var(--primary-glow)] active:bg-[var(--primary-active)]">
