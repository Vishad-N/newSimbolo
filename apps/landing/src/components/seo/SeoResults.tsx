    ...
    <SectionCard className="p-5">
      ...
      <div className="mt-5 grid grid-cols-2 gap-4 sm:grid-cols-4">
        {metrics.map((metric) => (
          <div key={metric.id} className="grid place-items-center text-center">
            <div className="grid h-[92px] w-[92px] place-items-center rounded-full border-[7px] border-[var(--accent)]/505075 bg-[var(--background)]/44 shadow-[0_0_24px_var(--accent-glow)]">
              <div>
      ...
      <div className="mt-4 flex justify-end gap-3">
        <button
          ...
          className="grid h-10 w-10 place-items-center rounded-full border border-white/10 text-white/75 transition hover:border-[var(--accent)]/505075 hover:text-white"
        >
