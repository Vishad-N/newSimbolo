...
export function MetricCard({ metric, index }: MetricCardProps) {
  ...
  return (
    <motion.div
      ...
      className="flex min-w-0 flex-1 items-center justify-start gap-4 border-white/10 px-4 py-4 w-full max-w-[240px] mx-auto sm:max-w-none sm:mx-0 sm:px-5 sm:w-full sm:justify-start lg:border-r last:lg:border-r-0"
    >
