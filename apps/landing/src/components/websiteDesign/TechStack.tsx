...
export function TechStack({ title = "TECHNOLOGIES WE WORK WITH", technologies }: TechStackProps) {
  return (
    <div className="mt-8">
      <div className="mb-6 flex flex-col items-center text-center">
        <h2 className="text-[1.35rem] font-black text-white uppercase">{title}</h2>
