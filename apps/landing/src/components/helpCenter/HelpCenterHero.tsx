...
export function HelpCenterHero({ searchQuery, onSearchChange, onSearchSubmit }: HelpCenterHeroProps) {
  return (
      ...
      <div className="relative z-10 mx-auto max-w-3xl">
        ...
        >
          <form
            ...
            className="relative mx-auto flex max-w-2xl items-center rounded-[100px] bg-[var(--surface)] p-2 pr-2 border border-white/10 shadow-[0_0_30px_rgba(0,0,0,0.5)] focus-within:border-[var(--accent)]/50 focus-within:shadow-[0_0_30px_rgba(34,211,238,0.15)] transition-all"
          >
            ...
            <button
              type="submit"
              className="hidden h-10 items-center justify-center rounded-full bg-[var(--accent)] px-6 text-[0.9rem] font-bold text-black transition hover:bg-[var(--accent-hover)] hover:shadow-[0_0_15px_var(--accent-glow)] sm:flex"
            >
              Search
            </button>
          </form>
