        ...
        {stats.map((stat, index) => {
          ...
          return (
            <motion.div
              ...
              className="group relative flex flex-col items-center justify-center text-center w-full mx-auto"
            >
              ...
              <div className="relative z-10 grid h-12 w-12 shrink-0 place-items-center rounded-full border border-[var(--accent)]/35 bg-[var(--background)] text-[var(--accent)] shadow-[0_0_15px_var(--accent-glow)] transition-all duration-300 group-hover:scale-110 group-hover:bg-[var(--primary)] group-hover:text-[#ffffff] mx-auto">
