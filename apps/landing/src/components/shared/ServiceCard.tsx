...
export function ServiceCard({ service, index }: ServiceCardProps) {
  ...
  return (
    <motion.article
      ...
      className="group relative flex flex-col justify-between h-full overflow-hidden rounded-[8px] border border-white/10 bg-[color-mix(in_srgb,var(--surface)_72%,transparent)] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] transition duration-300 hover:border-[var(--accent)]/50"
    >
      ...
      <div>
        <div className="relative grid h-12 w-12 place-items-center rounded-lg border border-[var(--accent)]/50 bg-[var(--accent-glow)] text-[var(--accent)] shadow-[0_0_30px_var(--accent-glow)]">
