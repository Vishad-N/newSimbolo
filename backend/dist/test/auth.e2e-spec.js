...
const email_service_1 = require("../src/shared/email/email.service");
...
describe('AuthController (e2e)', () => {
    ...
    const mockPrismaService = {
        ...
        user: {
            ...
            create: jest
                .fn()
                .mockImplementation(({ data }) => Promise.resolve({ ...mockUser, email: data.email, firstName: data.firstName, lastName: data.lastName })),
        },
        role: {
