...
let ProfilesController = class ProfilesController {
    ...
    async getClientProfile(user) {
        return this.profilesService.getClientProfile(user.sub);
    }
    async updateClientProfile(user, dto) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get current user client dashboard profile' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Client profile retrieved successfully.' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ProfilesController.prototype, "getClientProfile", null);
__decorate([
    (0, common_1.Put)('client'),
    (0, swagger_1.ApiOperation)({ summary: 'Update current user client dashboard profile' }),
    ...
    __metadata("design:returntype", Promise)
], ProfilesController.prototype, "updateClientProfile", null);
exports.ProfilesController = ProfilesController = __decorate([
    (0, swagger_1.ApiTags)('User Profiles Management'),
