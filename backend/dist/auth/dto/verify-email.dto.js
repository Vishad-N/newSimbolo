...
class VerifyEmailDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { email: { required: true, type: () => String, format: "email" }, token: { required: true, type: () => String } };
    }
}
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'abc123token-xyz', description: 'Email verification token' }),
