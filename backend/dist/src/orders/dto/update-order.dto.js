...
class UpdateOrderDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { status: { required: false, enum: ["ACTIVE", "DRAFT", "PENDING", "IN_PROGRESS", "COMPLETED", "CANCELLED", "PENDING_PAYMENT", "CONFIRMED", "UNDER_REVIEW", "REFUNDED"] }, notes: { required: false, type: () => String }, totalAmount: { required: false, type: () => Number, minimum: 0 }, taxAmount: { required: false, type: () => Number, minimum: 0 }, discountAmount: { required: false, type: () => Number, minimum: 0 }, netAmount: { required: false, type: () => Number, minimum: 0 } };
    }
}
