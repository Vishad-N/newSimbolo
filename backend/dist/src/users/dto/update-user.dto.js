...
class UpdateUserDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { firstName: { required: false, type: () => String }, lastName: { required: false, type: () => String }, phone: { required: false, type: () => String }, avatarUrl: { required: false, type: () => String, format: "uri" }, status: { required: false, enum: ["ACTIVE", "INACTIVE", "SUSPENDED", "PENDING_VERIFICATION"] }, roleId: { required: false, type: () => String, format: "uuid" }, organizationId: { required: false, type: () => String, format: "uuid" } };
    }
}
