...
let PrismaService = PrismaService_1 = class PrismaService extends client_1.PrismaClient {
    ...
    async onModuleInit() {
        ...
        try {
            ...
            this.logger.warn('⚠️ Please check your DATABASE_URL in `backend/.env` and verify your PostgreSQL username and password. If using Docker, ensure containers are running with `docker-compose up -d`.');
