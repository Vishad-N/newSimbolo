...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Initiates a payment order on Razorpay for a given internal order. Returns the gateway order ID needed for the client-side checkout.',
    }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Gateway order created successfully' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Order not found' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [payment_dto_1.CreatePaymentOrderDto, Object]),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Validates the HMAC-SHA256 signature from Razorpay on the server side. Never trusts client-side payment status.',
    }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Payment verified successfully' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Invalid payment signature' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List all payments (admin)' }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false, type: Number }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, type: Number }),
    (0, swagger_1.ApiQuery)({ name: 'status', required: false, enum: client_1.PaymentStatusEnum }),
...
__decorate([
    (0, common_1.Get)('my'),
    (0, swagger_1.ApiOperation)({ summary: "Get current client's own payment history" }),
    openapi.ApiResponse({ status: 200 }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get payment detail by ID' }),
