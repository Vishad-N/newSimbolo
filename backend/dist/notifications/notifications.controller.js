...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: "Get current user's notifications (paginated)" }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get unread notification count (for badge)' }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update notification channel preferences' }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, common_1.Request)()),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Dismiss (soft delete) a notification' }),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    openapi.ApiResponse({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __param(1, (0, common_1.Request)()),
