...
__decorate([
    ...
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all configured homepage sections (public)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Homepage sections returned' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get specific homepage section by key (e.g. hero, stats)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Section data returned' }),
    __param(0, (0, common_1.Param)('sectionKey')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], HomepageController.prototype, "getSection", null);
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Patch)(),
    (0, permissions_decorator_1.Permissions)('content.update'),
    (0, swagger_1.ApiOperation)({ summary: 'Update multiple homepage sections at once' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Homepage sections updated' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], HomepageController.prototype, "updateMultiple", null);
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Post)(),
    (0, permissions_decorator_1.Permissions)('content.create', 'content.update'),
    (0, swagger_1.ApiOperation)({ summary: 'Create or update a specific homepage section' }),
