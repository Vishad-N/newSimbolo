...
export declare class DocumentsController {
    ...
    findMyDocuments(user: JwtPayload, category?: DocumentCategoryEnum, page?: number, limit?: number): Promise<{
        data: ({
            company: {
                id: string;
                name: string;
    ...
    trackDownload(id: string, user: JwtPayload): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        deletedAt: Date | null;
    ...
    upload(file: Express.Multer.File, dto: UploadDocumentDto, user: JwtPayload): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        deletedAt: Date | null;
