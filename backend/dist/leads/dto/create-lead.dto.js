...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '+91', description: 'International dialing code' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.Matches)(phone_constant_1.COUNTRY_CODE_PATTERN, { message: phone_constant_1.COUNTRY_CODE_MESSAGE }),
    __metadata("design:type", String)
], CreateLeadDto.prototype, "countryCode", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '9876543210', description: 'Exactly 10 digits, without country code' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
