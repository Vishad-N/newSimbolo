...
export function MetricCard({ metric, index }: MetricCardProps) {
  ...
  return (
    ...
    >
      <div className="grid h-11 w-11 shrink-0 place-items-center rounded-full border border-[var(--primary)]/40 bg-[var(--primary-glow)] text-[var(--primary-light)] shadow-[0_0_26px_var(--primary-glow)]">
