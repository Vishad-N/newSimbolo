  ...
  return (
    <section className="mx-auto max-w-[1290px] border-t border-white/10 px-4 pt-4 sm:px-8 lg:px-10">
      <div className="mb-4 flex items-center justify-between">
        ...
        <a href="#" className="hidden items-center gap-2 text-[0.95rem] font-semibold text-[#2DD4BF] transition hover:text-[#14B8A6] sm:flex">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
        {services.map((service, index) => (
          <motion.article
            ...
            whileHover={{ y: -7 }}
            className="group relative min-h-[222px] overflow-hidden rounded-[8px] border border-white/[0.08] bg-[#111827]/86 p-4 shadow-[0_14px_30px_rgba(0,0,0,0.18)] transition duration-300 hover:border-white/[0.14] hover:shadow-[0_18px_42px_rgba(0,0,0,0.24)]"
          >
            <div className={cn("absolute -left-8 -top-10 h-32 w-32 rounded-full bg-gradient-to-br blur-2xl", accents[service.accent])} />

            <div className="relative flex h-full gap-4">
              <div className="relative min-h-[124px] w-[42%] shrink-0 self-start overflow-visible rounded-[8px]">
              ...
              <div className="flex min-w-0 flex-1 flex-col">
                ...
                <div className="mt-auto flex items-end justify-between gap-3 pt-4">
                  <div>
                    ...
                    <p className="text-[1.45rem] font-extrabold leading-6 text-[#D97706]">{service.price}</p>
                  </div>
                  <div className="inline-flex h-8 items-center gap-1.5 rounded-full border border-white/[0.08] bg-[#0B1120] px-3 text-[0.9rem] font-bold text-white">
