  ...
  return (
    <section className="mx-auto grid max-w-[1290px] gap-4 px-4 pt-5 sm:px-8 lg:grid-cols-[1fr_1.28fr_0.84fr] lg:px-10">
      <motion.article
        ...
        viewport={{ once: true }}
        className="rounded-[8px] border border-white/[0.08] bg-[#111827]/82 p-5"
      >
        ...
        <div className="grid grid-cols-5 items-start gap-2">
          {[
            ...
            <div key={String(top)} className="relative text-center">
              ...
              <div className="relative mx-auto grid h-14 w-14 place-items-center rounded-full border border-white/[0.08] bg-[#0B1120] text-[#2DD4BF] shadow-none first:bg-[#22C55E] first:text-white">
      ...
      >
        ...
        <div className="grid grid-cols-[58px_1fr] gap-4">
          ...
          <div>
            ...
            <div className="mb-3 flex gap-1 text-[#FBBF24]">★★★★★</div>
