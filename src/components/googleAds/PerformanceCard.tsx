...
const kpis = [
  { label: "Clicks", value: "12,456", change: "28.5%" },
  { label: "Conversions", value: "1,248", change: "32.7%" },
  { label: "Cost / Conv.", value: "₹120.45", change: "18.8%" },
  { label: "Conv. Value", value: "₹8.45 L", change: "41.3%" },
];
    ...
    <SectionCard className="overflow-hidden p-5">
      ...
      <div className="relative mt-5 h-[138px]">
        ...
        <div className="absolute inset-y-2 left-9 right-0">
          ...
          <motion.div initial={{ clipPath: "inset(0 100% 0 0)" }} animate={{ clipPath: "inset(0 0% 0 0)" }} transition={{ duration: 1.2, ease: "easeOut" }} className="absolute inset-0 text-[var(--primary-light)]">
            <div className="absolute bottom-0 left-0 h-full w-full bg-linear-to-t from-[var(--primary)]/34 to-transparent [clip-path:polygon(0_88%,6%_72%,13%_68%,19%_42%,25%_48%,31%_35%,38%_39%,44%_20%,50%_36%,56%_33%,62%_39%,69%_31%,76%_14%,83%_27%,90%_34%,96%_16%,100%_2%,100%_100%,0_100%)]" />
