        ...
        {steps.map((step, index) => {
          ...
          return (
            <motion.div key={step.id} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.08, duration: 0.42 }} className="relative text-center">
              <div className="mx-auto grid h-13 w-13 place-items-center rounded-full border border-[var(--primary)]/55 bg-[var(--card)] text-[var(--primary-light)] shadow-[0_0_22px_var(--primary-glow)]">
