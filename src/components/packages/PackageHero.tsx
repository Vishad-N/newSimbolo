  ...
  return (
    <section className="relative min-h-[260px] overflow-hidden px-5 pt-4 text-center sm:px-8 lg:px-10">
      <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }} className="relative z-10 mx-auto max-w-[760px]">
        <div className="mx-auto inline-flex h-8 items-center gap-2 rounded-full border border-white/12 bg-[#07101B]/90 px-4 text-[0.76rem] font-extrabold uppercase text-[#B9FF00] shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
          <Boxes className="h-4 w-4" />
          Packages & Pricing
        </div>

        <h1 className="mx-auto mt-4 max-w-[720px] text-balance text-[2.1rem] font-black leading-[1.05] tracking-normal text-white sm:text-[3rem] lg:text-[3.35rem]">
          Choose the perfect package
          <span className="block text-[#B9FF00]">to grow your business</span>
        </h1>
      ...
      >
        ...
        <div className="absolute right-3 top-40 grid h-[62px] w-[78px] place-items-center rounded-[10px] border border-[#0DE2BC]/18 bg-[#07101B]/78 shadow-[0_16px_42px_rgba(0,0,0,0.22)]">
          <div className="h-9 w-9 rounded-full border-[9px] border-[#24A8FF] border-b-[#EF4444] border-r-[#7C3AED]" />
        </div>
        <div className="absolute right-8 top-[46px] h-[86px] w-[96px] rounded-[9px] border border-[#0DE2BC]/22 bg-[#07101B]/72 p-4 text-[#0DE2BC] shadow-[0_16px_42px_rgba(0,0,0,0.24)]">
