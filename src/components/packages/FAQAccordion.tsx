    ...
    <section className="mt-8 pb-10">
      ...
      <div className="mt-3 grid gap-4 lg:grid-cols-3">
        {items.map((item) => {
          ...
          return (
            <div key={item.id} className="rounded-[8px] border border-white/10 bg-[#07101B]/78">
              <button
                type="button"
              ...
              >
                ...
                <Plus className={cn("h-5 w-5 shrink-0 text-white/80 transition duration-300", open && "rotate-45 text-[#B9FF00]")} />
              </button>
