      ...
      <div className="relative z-10 flex flex-col items-center justify-between gap-8 md:flex-row">
        ...
        <div className="flex flex-col items-center text-center md:items-start md:text-left md:flex-row md:gap-6">
          <motion.div 
            ...
            className="relative h-24 w-24 shrink-0 overflow-hidden rounded-full border-2 border-[var(--primary)]/30 shadow-[0_0_30px_rgba(233,2,181,0.2)] md:h-32 md:w-32 bg-[var(--surface)]"
          >
          ...
          <div className="mt-4 md:mt-0 max-w-[320px]">
            <h2 className="text-[1.8rem] md:text-[2.2rem] font-black leading-tight text-white">
        ...
        <div className="flex w-full flex-col items-center gap-6 md:w-auto md:items-end">
          <div className="flex w-full flex-wrap justify-center gap-6 md:justify-end">
            <div className="flex items-center gap-3">
              <Users className="h-8 w-8 text-[var(--primary-light)]" />
              <div>
                <div className="text-[1.3rem] font-black text-white leading-none">1,000+</div>
            ...
            <div className="flex items-center gap-3">
              <HandCoins className="h-8 w-8 text-[var(--primary-light)]" />
              <div>
                <div className="text-[1.3rem] font-black text-white leading-none">₹50L+</div>
            ...
            <div className="flex items-center gap-3">
              <Smile className="h-8 w-8 text-[var(--primary-light)]" />
              <div>
                <div className="text-[1.3rem] font-black text-white leading-none">98%</div>
                <div className="text-[0.7rem] font-semibold text-white/50 mt-1">Satisfaction Rate</div>
              </div>
            </div>
          </div>
          
          <Link href="/contact?type=affiliate" className="mt-2 inline-flex h-12 w-full items-center justify-center gap-2 rounded-[8px] bg-[var(--primary)] px-8 text-[0.95rem] font-bold text-black transition hover:bg-[var(--primary-hover)] hover:scale-[1.02] shadow-[0_10px_20px_var(--primary-glow)] md:w-auto">
