...
type WebsiteRecentWorksProps = {
  works: Project[];
};

export function WebsiteRecentWorks({ works }: WebsiteRecentWorksProps) {
  return (
        ...
        {works.map((work, index) => (
          ...
          >
            ...
            <div className="flex flex-col flex-1 p-4">
              <h3 className="text-[1.05rem] font-bold leading-tight text-white">{work.title}</h3>
              <p className="mt-1 text-[0.78rem] font-medium text-[var(--primary-light)]">{work.category}</p>
              ...
              <div className="mt-auto">
                <Link href={work.link} className="inline-flex h-9 items-center justify-center gap-2 rounded-[6px] border border-white/20 bg-white/5 px-4 text-[0.8rem] font-bold text-white transition hover:bg-white/10 w-full sm:w-auto">
                  Visit Project
